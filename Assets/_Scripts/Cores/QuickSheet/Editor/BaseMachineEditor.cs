...
namespace UnityQuickSheet
{
    ...
    public class BaseMachineEditor : Editor
    {
        ...
        {
            sp.className = machine.WorkSheetName + "_SO";
            sp.dataClassName = machine.WorkSheetName;
        ...
        protected void CreateScriptableObjectEditorClassScript(BaseMachine machine, ScriptPrescription sp)
        {
            ...
            sp.worksheetClassName = machine.WorkSheetName+"_SO";
            sp.dataClassName = machine.WorkSheetName ;
        ...
        /// <summary>
        /// e.g. "Assets/Script/Data/Runtime/Item_SO.cs"
        /// </summary>
        protected string TargetPathForClassScript(string worksheetName)
        {
            return Path.Combine("Assets/" + machine.RuntimeClassPath, worksheetName + "_SO" + "." + "cs");
        }
